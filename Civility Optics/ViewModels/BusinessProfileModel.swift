...
class BusinessProfileModel: ObservableObject {
    ...
    func businessUpdate(email: String, business_key: String, business_name: String, business_addr: String, business_description: String, token: String) {
      ...
      NetworkingService.businessUpdate(email: email, business_key: business_key, business_name: business_name, business_addr: business_addr, business_description: business_description, token: token) { result in
